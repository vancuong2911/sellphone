...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $brand_update = $brand -> update_brand($brand_name,$brand_img_link,$brand_link_web,$brand_id);
      ...
      <div class="page-content form-page p-5">
            ...
            <div class="bg-dash-dark-2 py-4">
              <div class="container-fluid">
                <h2 class="h5 mb-0">Edit Brands</h2>
              </div>
            </div>
            <!-- Breadcrumb-->
        ...
        <section class="tables py-10">
          <div class="container-fluid">
            <div class="row gy-4">
              <div class="col">
                <form class="card mb-0 p-2" method="POST" action=""  enctype="multipart/form-data">
                <span><?php 
                  ...
                  <div class="card-header d-flex justify-content-between">
                    <h3 class="h2 mb-0">Edit Brands</h3>
                  </div>
                  <div class="card-body pt-0">
                    <div class="table-responsive">
                      <table class="table mb-0">
                        <?php 
                            $get_brand = $brand->getId_brand($brand_id);
                            if($get_brand) {
                        ...
                        <tbody>
                          ...
                          <td class="border-bottom-0">
                              <input type="text" class="p-2 rounded" name="brand_name" value="<?php echo $result['name']?>" placeholder="Edit Brand Name...">
                            </td>
                            <td class="border-bottom-0">
                              <input type="file" class="p-2" name="brand_img_link" value="<?php echo $result['image_url']?>">
                            </td>
                            <td class="border-bottom-0">
                                <input type="text" class="p-2 rounded" name="brand_link_web" value="<?php echo $result['link'] ?>" placeholder="Edit Brand Link Website...">
                            </td>
                            <td class="border-bottom-0">
